...
//    UserController uc;
    ...
    public void createUserObjectTest() {
        ...
        User user = new User("test@test.edu", "Mike");
    ...
    public void registerUserTest(){
        ...
        when(ur.save(isA(User.class))).thenReturn(new User("test@test.edu", "Sarah"));

        UserController uc = new UserController(ur);
        User user = uc.registerUser("test@test.edu", "Sarah");

        assertEquals("test@test.edu", user.getUser());
        assertEquals("Sarah", user.getFirst_name());
    }
